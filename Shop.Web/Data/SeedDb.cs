namespace Shop.Web.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await this.CheckUserAsync("Customer1@gmail.com", "Customer1", "Customer1", "Customer1");
            await this.CheckUserAsync("Customer2@gmail.com", "Customer2", "Customer2", "Customer2");
            var user = await this.CheckUserAsync("Customer3@gmail.com", "Customer3", "Customer3", "Customer3");
